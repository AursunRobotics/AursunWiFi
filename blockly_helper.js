...
*/
function saveCode() {
  var fileName = window.prompt('What would you like to name your file?', 'autosim')
...
function save() {
  ...
  var fileName = window.prompt('What would you like to name your file?', 'AursunRobotics');
  // Store data in blob.
